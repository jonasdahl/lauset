...
import { AdminApi, Configuration as HydraConfiguration } from '@ory/hydra-client'
...
export function getUrlForKratosFlow(base: string, flow: string, query?: URLSearchParams) {
